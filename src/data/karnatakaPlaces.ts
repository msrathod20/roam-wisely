...
const SEEDS: Seed[] = [
  ...
  // ===== MYSURU =====
  { name: "Mysore Palace", district: "Mysuru", description: "Indo-Saracenic royal palace, official residence of the Wodeyar dynasty.", category: "heritage", lat: 12.3052, lng: 76.6552, rating: 4.7, image: W.bangalorePalace, whyFamous: "One of India's most visited monuments, illuminated by 97,000 bulbs on Sundays.", thingsToTry: ["Sunday illumination (7-7:45 PM)", "Durbar Hall", "Dussehra procession"], history: "Rebuilt in 1912 after fire, designed by British architect Henry Irwin.", entryFee: "₹70" },
