    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Tell us what you love to explore</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border p-6 space-y-4 card-elevated">
          ...
          <div>
            <label className="text-sm font-medium text-foreground block mb-2">Your Interests</label>
